...
app = Flask(__name__)
#points to existing database
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///app.db'
# false to avoid  building too much data in memory
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False

#configures the app and models for flask-migrate
migrate = Migrate(app, db)

#connects db to application before it runs
db.init_app(app)

#determines resources per url and saves to url map
@app.route('/')
def index():
